...
<tr><td style="padding:40px;">
  ...
  <p style="color:#555;font-size:15px;line-height:1.6;">Ваше бронирование на дегустацию вин подтверждено и оплачено. Ждём вас!</p>

  <table width="100%" cellpadding="8" cellspacing="0" style="margin:24px 0;border-collapse:collapse;">
    <tr><td style="color:#7A8F7A;font-size:12px;text-transform:uppercase;letter-spacing:1px;padding:8px 0;border-bottom:1px solid #eee;">Дегустация</td>
    ...
    <?php if (!empty($event['duration_minutes'])): ?>
    <tr><td style="color:#7A8F7A;font-size:12px;text-transform:uppercase;letter-spacing:1px;padding:8px 0;border-bottom:1px solid #eee;">Длительность</td>
        <td style="font-size:15px;padding:8px 0;border-bottom:1px solid #eee;"><?= (int)$event['duration_minutes'] ?> минут</td></tr>
    <?php endif; ?>
